...
class DiffusiveRestoration:
    def __init__(self, diffusion, args, config):
        ...
        if os.path.isfile(args.resume):
            self.diffusion.load_ddm_ckpt_test(args.resume, ema=True)
